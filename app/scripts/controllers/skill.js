...
angular.module('cvApp')
  .controller('SkillCtrl', function ($scope) {
    $scope.items = [
      ...
      {key: '前端框架', value: 'Bootstrap/AngularJS/React/RequireJS/Browserify'},
      {key: '前端工具', value: 'Bower/Grunt/Yo/Gulp/'},
      {key: '数据库相关', value: 'Mysql/MongoDB/SQLite'},
      {key: '版本管理', value: 'SVN/Git'},
      {key: '单元测试', value: 'JUnit/Karma'},
      {key: '移动开发', value: 'Android/NDK/React Native/Hybrld App/JQuery Mobile'},
